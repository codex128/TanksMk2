...
public class GameStyles {
    ...
    public static final String STYLE = "game";
    ...
    public static void load(AssetManager assetManager) {
        ...
        attr = styles.getSelector("progress.value", "health-bar");
        attr.set("background", new QuadBackgroundComponent(ColorRGBA.Red));
        
        attr = styles.getSelector("progress.container", "health-bar");
        //attr.set("background", new QuadBackgroundComponent(ColorRGBA.BlackNoAlpha));
        
        attr = styles.getSelector("progress.label", "health-bar");
        attr.set("fontSize", 10);
